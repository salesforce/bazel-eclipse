...
public class JavaIdeInfoTest {
    ...
    public void testUnchangedFromSerializationRoundTrip() {
        var proto = IntellijIdeInfo.JavaIdeInfo.newBuilder().addSources(artifactLocation("com/google/lib/Source.java"))
                .addSources(artifactLocation("com/google/other/Other.java"))
                .addJars(IntellijIdeInfo.LibraryArtifact.newBuilder().setJar(artifactLocation("jar.jar"))
                        .setInterfaceJar(artifactLocation("jar.ijar")).addSourceJars(artifactLocation("jar.srcjar")))
                .addGeneratedJars(IntellijIdeInfo.LibraryArtifact.newBuilder().setJar(artifactLocation("genjar.jar"))
