...
public class FSPathHelperTest {
    ...
    public void test_Windows_Happy() {
        ...
        String originalPath = "one/two/three/four";
    ...
    public void test_Windows_DoubleEscape() {
        ...
        String originalPath = "one/two/three/four";
        String convertedPath = FSPathHelper.osSeps(originalPath);
    ...
    public void test_Windows_EscapeEscape() {
        ...
        String originalPath = "one/two/three/four";
        String convertedPath = FSPathHelper.osSepsEscaped(originalPath);
