...
public class BazelImportWizardProjectViewPage extends WizardPage {
    ...
    private final Supplier<IPath> projectViewInitializer;

    public BazelImportWizardProjectViewPage(Supplier<IPath> projectViewInitializer) {
        super("Import Bazel Workspace");
        this.projectViewInitializer = projectViewInitializer;
    ...
    public void setVisible(boolean visible) {
        if (projectViewInitializer != null) {
            var path = projectViewInitializer.get();
            if (path != null) {
                projectViewDialogField.setText(path.toOSString());
            }
        }
