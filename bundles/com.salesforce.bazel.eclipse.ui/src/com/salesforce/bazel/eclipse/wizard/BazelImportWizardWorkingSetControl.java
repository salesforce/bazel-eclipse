...
public class BazelImportWizardWorkingSetControl {
    ...
    public static IWorkingSet getAssignedWorkingSet(IResource element) {
        var workingSetManager = PlatformUI.getWorkbench().getWorkingSetManager();
    ...
    public void addWorkingSetControl(Composite composite) {
        ...
        createWorkingSet.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                var enabled = createWorkingSet.getSelection();
        ...
        var gd_workingSet = new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1);
    ...
    public void setWorkingSetName(String workingSetName) {
        preselectedWorkingSetName = workingSetName;
    }
    ...
    void updateWorkingSet(BazelPackageInfoOld rootWorkspacePackage) {
        ...
        var rootDirectory = page.locationControl.rootDirectoryCombo != null
        ...
        if ((rootDirectory != null) && (rootDirectory.length() > 0)) {
            ...
            var rootURI = new File(rootDirectory).toURI();
            var containers = page.locationControl.workspaceRoot.findContainersForLocationURI(rootURI);
