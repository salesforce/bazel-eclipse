...
public class BazelImportWizardLabelProvider extends LabelProvider
    ...
    public Color getForeground(Object element) {
        if ((element instanceof IResource) && isKnownModule()) {
    ...
    public StyledString getStyledText(Object element) {
        if (element instanceof BazelPackageInfoOld info) {
            ...
            var label = info.getBazelPackageFSRelativePathForUI();
            ss.append(label + "  ");

            var bazelPath = info.getBazelPackageName();
