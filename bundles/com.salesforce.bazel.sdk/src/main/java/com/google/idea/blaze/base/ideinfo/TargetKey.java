...
public final class TargetKey implements ProtoWrapper<IntellijIdeInfo.TargetKey>, Comparable<TargetKey> {
    ...
    public static TargetKey fromProto(IntellijIdeInfo.TargetKey proto) {
        return ProjectDataInterner.intern(
            new TargetKey(Label.fromProto(proto.getLabel()), ProtoWrapper.internStrings(proto.getAspectIdsList())));
    }
    ...
    public int compareTo(TargetKey o) {
        return ComparisonChain.start().compare(getLabel(), o.getLabel())
                .compare(getAspectIds(), o.getAspectIds(), Ordering.natural().lexicographical()).result();
    }
    ...
    public boolean equals(Object o) {
        ...
        var key = (TargetKey) o;
        return Objects.equal(getLabel(), key.getLabel()) && Objects.equal(getAspectIds(), key.getAspectIds());
    }
    ...
    public IntellijIdeInfo.TargetKey toProto() {
        return IntellijIdeInfo.TargetKey.newBuilder().setLabel(label.toProto()).addAllAspectIds(aspectIds).build();
    }
