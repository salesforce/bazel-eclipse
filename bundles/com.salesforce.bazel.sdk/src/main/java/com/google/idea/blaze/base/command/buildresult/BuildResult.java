...
public class BuildResult {
    ...
    public enum Status {
        ...
        private static Status fromExitCode(int exitCode) {
            ...
            if (exitCode == BUILD_ERROR_EXIT_CODE) {
                return BUILD_ERROR;
            }
            return FATAL_ERROR;
        }
    ...
    private static int combineExitCode(int first, int second) {
        ...
        var firstStatus = Status.fromExitCode(first);
        var secondStatus = Status.fromExitCode(second);
    ...
    public boolean equals(Object object) {
        if (!(object instanceof BuildResult buildResult)) {
            return false;
        }
