...
public final class Dependency implements ProtoWrapper<IntellijIdeInfo.Dependency> {
    static Dependency fromProto(IntellijIdeInfo.Dependency proto) {
        return ProjectDataInterner
                .intern(new Dependency(TargetKey.fromProto(proto.getTarget()), proto.getDependencyType()));
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(getTargetKey(), that.getTargetKey()) && (getDependencyType() == that.getDependencyType());
    }
    ...
    public IntellijIdeInfo.Dependency toProto() {
        return IntellijIdeInfo.Dependency.newBuilder().setTarget(targetKey.toProto()).setDependencyType(dependencyType)
                .build();
    }
