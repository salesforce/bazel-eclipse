 ...
 */
public class TargetExpression implements ProtoWrapper<String>, Comparable<TargetExpression>, Serializable {
    ...
    public static String validate(String targetPattern) {
        ...
        if (targetPattern.charAt(0) == '@') {
            ...
            if (!VALID_REPO_NAME.matcher(targetPattern.substring(0, slashesIndex)).matches()) {
                return String.format("Invalid target expression '%s': workspace names may contain only "
                        + "A-Z, a-z, 0-9, '-', '_' and '.'",
                    targetPattern);
            }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof TargetExpression that)) {
            return false;
        }
