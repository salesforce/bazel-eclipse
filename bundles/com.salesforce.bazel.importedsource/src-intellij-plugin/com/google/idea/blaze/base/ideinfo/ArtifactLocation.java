...
public final class ArtifactLocation implements ProtoWrapper<Common.ArtifactLocation>, Comparable<ArtifactLocation> {
    /** Builder for an artifact location */
    public static class Builder {
        public static Builder copy(ArtifactLocation artifact) {
            return new Builder().setRelativePath(artifact.getRelativePath())
                    .setRootExecutionPathFragment(artifact.getRootExecutionPathFragment())
                    .setIsSource(artifact.isSource()).setIsExternal(artifact.isExternal());
        }
    ...
    public static ArtifactLocation fromProto(Common.ArtifactLocation proto) {
        return ProjectDataInterner.intern(new ArtifactLocation(proto.getRootExecutionPathFragment().intern(),
                proto.getRelativePath(), proto.getIsSource(), proto.getIsExternal()));
    }
    ...
    private ArtifactLocation(String rootExecutionPathFragment, String relativePath, boolean isSource,
            boolean isExternal) {
        this.rootExecutionPathFragment = rootExecutionPathFragment;
        this.relativePath = relativePath;
        this.isSource = isSource;
    ...
    public int compareTo(ArtifactLocation o) {
        return ComparisonChain.start().compare(getRootExecutionPathFragment(), o.getRootExecutionPathFragment())
                .compare(getRelativePath(), o.getRelativePath()).compareFalseFirst(isSource(), o.isSource())
                .compareFalseFirst(isExternal(), o.isExternal()).result();
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(getRootExecutionPathFragment(), that.getRootExecutionPathFragment())
                ...
                && Objects.equal(isSource(), that.isSource()) && Objects.equal(isExternal(), that.isExternal());
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(getRootExecutionPathFragment(), getRelativePath(), isSource(), isExternal());
    }
    ...
    public Common.ArtifactLocation toProto() {
        return Common.ArtifactLocation.newBuilder().setRootExecutionPathFragment(rootExecutionPathFragment)
                .setRelativePath(relativePath).setIsSource(isSource).setIsExternal(isExternal).build();
    }
