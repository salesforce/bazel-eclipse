...
public interface MacroCallAnalyzer {
    ...
    /**
     * Called by {@link BuildFileAndVisibilityDrivenProvisioningStrategy} to analyze the given {@link MacroCall} and add
     * any relevant information to {@link JavaProjectInfo}.
     *
     * @param macroCall
     *            the {@link MacroCall} to analyze (never <code>null</code>)
     * @param javaInfo
     ...
     *             if there is a problem analyzing the {@link MacroCall} which should be reported
     */
    boolean analyze(MacroCall macroCall, JavaProjectInfo javaInfo) throws CoreException;
