...
public class TestAspectFileCreator {
    ...
    static String createJavaAspectFileForMavenJar(File outputBase, String mavenJarName, String actualJarNameNoSuffix) {
        ...
        String json = createAspectJsonForJavaArtifact(externalName + "/jar/BUILD.bazel", dependencies, sources,
            mainClass, label, kind, jar, interfacejar, sourcejar);
        File aspectJsonFile =
                createJavaAspectFileWithThisJson(outputBase, externalName + "/jar", "jar.bzleclipse-build.json", json);
    ...
    static String createAspectJsonForJavaLibraryTarget(String packageRelativePath, String packageName,
        ...
        return createAspectJsonForJavaArtifact(packageRelativePath + "/BUILD", dependencies, sources, mainClass, label,
    ...
    static String createAspectJsonForJavaTestTarget(String packageRelativePath, String packageName, String targetName,
        ...
        return createAspectJsonForJavaArtifact(packageRelativePath + "/BUILD", dependencies, sources, mainClass, label,
            "java_test", jar, interfacejar, sourcejar);
