...
public class TestAspectFileCreator {
    ...
    public static String createJavaAspectFileForMavenJar(File outputBase, String mavenJarName,
        ...
        String json = createAspectJsonForJavaArtifact(FSPathHelper.osSepsEscaped(externalName + "/jar/BUILD.bazel"), // $SLASH_OK
            true, dependencies, sources, mainClass, label, kind, jar, interfacejar, sourcejar);
        File aspectJsonFile =
     ...
     * @return the absolute File path to the file
     */
    public static String createJavaAspectFileForImportJar(File outputBase, String packageLabelRelativePath,
        ...
        String json = createAspectJsonForJavaArtifact(FSPathHelper.osSepsEscaped(buildFile),
            false, dependencies, sources, mainClass, label, kind, jar, interfacejar, sourcejar);
        File aspectJsonFile = createJavaAspectFileWithThisJson(outputBase,
